...
[https://jauntsdn.github.io/post/netty-websocket-http2/](https://jauntsdn.github.io/post/netty-websocket-http2/)
...
Http2Headers headers =
   new DefaultHttp2Headers().set("user-agent", "jauntsdn-websocket-http2-client/1.5.0");
...
dependencies {
    implementation 'com.jauntsdn.netty:netty-websocket-http2:1.5.0'
}
```
